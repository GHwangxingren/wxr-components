<template>
  <div class="hxe-checkbox-container">
    <div
      ...
      :class="{ actived: localSelect.includes(item[code]) }"
    ...
    >
      <el-tooltip :disabled="showTip" :effect="effect" :content="`俺是${item[title]}`" :placement="placement">
        <div class="hxe-checkbox-item-content" :style="{ textAlign: align }">
          <i
            v-if="hasDelete && item[deleteIcon]"
          ...
          <span v-if="isEdit && editIndex === index" class="hxe-checkbox-item-title hxe-checkbox-item-title-input">
